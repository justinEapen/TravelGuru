...
st.image("https://source.unsplash.com/1600x900/?travel,holiday", use_column_width=True)
...
def main():
    ...
    st.image("https://source.unsplash.com/1200x400/?beach,mountains", use_column_width=True)
    ...
    if st.button("🌍 Generate Itinerary ✨"):
        if destination and start_date and days:
            ...
            st.image("https://source.unsplash.com/1200x600/?tourism,landscape", use_column_width=True)
